            ...
            try:
                with httpx.Client(timeout=min(10, self.timeout)) as c:
                    ...
                    if r.status_code == 200:
                        ...
                        if img:
                            if on_progress:
                                on_progress(1.0, {"history": True})
                            return img, {
                                "origin": "comfyui-history",
                                "prompt_id": prompt_id,
                            }
            except Exception:
                pass
            ...
            async with websockets.connect(url, ping_interval=None) as ws:
                for _ in range(10):
                    try:
                        ...
                        if on_progress:
                            on_progress(0.1, {"ws": True, "msg": str(msg)[:200]})
