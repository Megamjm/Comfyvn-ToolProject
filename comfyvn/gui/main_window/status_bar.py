...
class StatusBarMixin:
    def _init_status(self):
        ...
        self._lbl_cpu = QLabel("CPU: â€“"); self._lbl_mem = QLabel("RAM: â€“"); self._lbl_gpu = QLabel("GPU: â€“")
        ...
        self._timer.timeout.connect(self._poll_metrics); self._timer.start()
    ...
    def _poll_metrics(self):
        ...
        try:
            ...
            if r.ok:
                ...
                if gpus:
                    g = gpus[0]
                    self._lbl_gpu.setText(f"GPU: {g.get('util','-')}% {g.get('mem_used','-')}/{g.get('mem_total','-')}MB")
                else:
    ...
    def _down(self):
        ...
        self._lbl_cpu.setText("CPU: â€“"); self._lbl_mem.setText("RAM: â€“"); self._lbl_gpu.setText("GPU: â€“")