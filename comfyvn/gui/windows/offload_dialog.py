...
from PySide6.QtWidgets import QDialog, QVBoxLayout, QLabel, QLineEdit, QTextEdit, QPushButton, QMessageBox
...
class OffloadDialog(QDialog):
    def __init__(self, parent=None, base="http://127.0.0.1:8001"):
        ...
        b=QPushButton("Send"); lay.addWidget(b)
    ...
    def send(self):
        try:
            ...
            QMessageBox.warning(self,"JSON",str(e)); return
        endpoint=self.endpoint.text().strip()
        try:
            r=requests.post(self.base+"/render/offload",json={"endpoint":endpoint,"payload":payload},timeout=10)
