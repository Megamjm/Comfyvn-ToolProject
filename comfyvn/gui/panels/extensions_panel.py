...
from PySide6.QtWidgets import QWidget, QVBoxLayout, QListWidget, QPushButton, QLabel, QDockWidget
...
class ExtensionsPanel(QDockWidget):
    def __init__(self):
        ...
        lay.addWidget(QLabel("Installed Extensions:")); lay.addWidget(self.list)
