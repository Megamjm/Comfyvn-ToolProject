...
class BusyOverlay(QWidget):
    def __init__(self, text: str="Working…", parent=None):
        super().__init__(parent)
        lay = QVBoxLayout(self); lay.addStretch(1)
...
__all__ = [
    "HSpacer","VSpacer","Line","SearchBox","SectionHeader","IconButton","StatusBadge",
    "BusyOverlay","ElideLabel","LabeledAction","FormRow","ToggleRow","KVList","KeyValueList",
    "Pill","HintLabel","Toolbar","PathPicker","LogConsole",
]
...
def __getattr__(name: str):
    ...
    class _Fallback(QWidget):
        def __init__(self, *args, **kwargs):
            ...
            lay = QVBoxLayout(self)
            lab = QLabel(name); lab.setAlignment(Qt.AlignCenter)
            lay.addWidget(lab)
